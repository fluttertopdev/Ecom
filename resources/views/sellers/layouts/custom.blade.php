<script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if(pagename == 'sellerscoupon'){
                  window.location.href = "/sellers-delete-coupon/" + itemId;
                }

                else if(pagename == 'withdraw_request'){
                  window.location.href = "delete-withdrawl-request/" + itemId;
                }
