      ...
      <div class="authentication-inner row">
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <h3 class="mb-1">Seller Login</h3>
            <p class="mb-4">Login seller and explore</p>
             <form id="formAuthentication" class="mb-3" action="{{ url('/do-seller-login') }}" method="POST">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="remember-me"> {{__('lang.admin_remember_me')}}</label>
                </div>
              </div>
              <button class="btn btn-primary d-grid w-100">{{__('lang.admin_login')}}</button>
            </form>
