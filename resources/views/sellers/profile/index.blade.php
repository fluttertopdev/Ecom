              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <!-- Account -->
                    <div class="card-body">
                      <form id="" method="POST" action="{{url('sellers-update-profile')}}" enctype="multipart/form-data">
                        @csrf
                      <input type="hidden" name="id" value="{{$row->id}}">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img width="100px" height="100px;" style="object-fit: contain;"
                          src="{{ url('uploads/sellers/'.$row->image)}}"
                          alt="user-avatar"
                          class="d-block w-px-100 h-px-100 rounded"
                          id="uploadedAvatar" onerror="this.onerror=null;this.src=`{{ asset('uploads/no-image.png') }}`"/>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                name="phone"
                                class="form-control"
                                placeholder="Phone" value="{{$row->phone}}" required/>
                            </div>
                          </div>
