...
<div class="card-header">
    <div class="row">
        <div class="col-md-6">
            <h5>Wthdraw Requests History</h5>
        </div>
        <div class="col-md-6">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($row->status == 1)
                        <a href="#">
                            <span class="badge bg-success">Approved</span></a>
                        @else
                        <a href="#">
                    ...
                    <div class="offcanvas offcanvas-end" id="edit-new-record_{{$row->id}}">
                        <div class="offcanvas-header border-bottom">
                            <h5 class="offcanvas-title"
                                id="exampleModalLabel">Edit Wthdraw Requests </h5>
                            <button type="button" class="btn-close text-reset"
                                data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body flex-grow-1">
                            <form action="{{url('sellers-withdraw-requests')}}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$row->id}}">
                                <div class="col-sm-12">
                                    <label class="form-label"
                                        for="name">Amount<span class="required">*</span></label>
                                 ...
                                 <div class="col-sm-12">
                                    <label class="form-label"
                                        for="name">Message<span class="required">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <textarea type="text" id="basicFullname"
                                            ...
                                            placeholder="Message"
                                            aria-label="John Doe"
                                            aria-describedby="basicFullname2" required />{{$row->message}}</textarea>
