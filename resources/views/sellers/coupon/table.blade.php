        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                 ...
                 @if (in_array('update-coupon-column', \Helpers::sellergetAssignedPermissions()))
                    <td>
                        @if($row->status == 1)
                        <a href="{{ url('sellers-update-coupon-column/'.$row->id) }}">
               ...
               @endif
                    ...
                    <td>
                        <div class="inline_action_btn">
                            @if (in_array('update-coupon', \Helpers::sellergetAssignedPermissions()))
                                <a class="edit_icon" href="javascript:void(0);"
                                    ...
                                    @endif
                                  @if (in_array('delete-coupon', \Helpers::sellergetAssignedPermissions()))
                                <a class="delete_icon" href="javascript:void(0);"
                                onclick="showDeleteConfirmation('sellerscoupon' , {{ $row->id }})"
                    ...
                    <!-- Modal to edit new record -->
                      <div class="offcanvas offcanvas-end" id="edit-new-record_{{$row->id}}">
                        ...
                        <div class="offcanvas-body flex-grow-1">
                            <form action="{{url('sellers-update-coupon')}}" method="POST"
