<div class="offcanvas offcanvas-end" id="add-new-record">
    ...
    <div class="offcanvas-body flex-grow-1">
        <form action="{{url('sellers-save-coupon')}}" method="POST"
            ...
            <div class="col-sm-12">
             ...
             <div class="col-sm-12">
                ...
                <div class="input-group input-group-merge">
                   <input class="form-control" type="date" name="start_date" value="" id="" required />
                </div>
            </div>
              ...
              <div class="col-sm-12">
                ...
                <div class="input-group input-group-merge">
                   <input class="form-control" type="date" name="expire_date" value="" id="html5-date-input" required />
                </div>
            </div>
