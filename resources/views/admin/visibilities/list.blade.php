...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-md-6">
                <div class="table-btn-css">
                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="offcanvas"
                        ...
                        <span class="ti-xs ti ti-plus me-1"></span>Add Visibilities
                    </button>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 display-inline-block">
                            ...
                            <a type="reset" class="btn btn-outline-secondary"
                                href="{{url('admin/visibilities')}}">{{__('lang.admin_reset')}}</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <!-- Bordered Table -->
        @include('admin/visibilities/table')
        <!--/ Bordered Table -->

        <!-- Modal to add new record -->
        @include('admin/visibilities/add_modal')
        <!--/ Modal to add new record -->
