        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($row->status == 1)
                        <a href="{{ url('admin/currency-column/'.$row->id) }}">
                    ...
                    <td>
                        <div class="inline_action_btn">
                                ...
                                onclick="showDeleteConfirmation('currency' , {{ $row->id }})"
                    ...
                    <div class="offcanvas offcanvas-end" id="edit-new-record_{{$row->id}}">
                        <div class="offcanvas-header border-bottom">
                            <h5 class="offcanvas-title"
                                id="exampleModalLabel">Edit Currency</h5>
                            <button type="button" class="btn-close text-reset"
                                data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body flex-grow-1">
                            <form action="{{url('admin/update-currency')}}" method="POST"
                                ...
                                <div class="col-sm-12">
                                 ...
                                 <div class="col-sm-12">
                                    <label class="form-label"
                                        for="name">Symbol<span class="required">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="basicFullname"
                                            class="form-control dt-full-name" name="symbol"
                                            value="{{$row->symbol}}"
                                            placeholder="Symbols"
                                            aria-label="John Doe"
                                            aria-describedby="basicFullname2" required />
                                  ...
                                  <div class="col-sm-12">
                                    <label class="form-label"
                                        for="name">Currency Code<span class="required">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="basicFullname"
                                            class="form-control dt-full-name" name="code"
                                            value="{{$row->code}}"
