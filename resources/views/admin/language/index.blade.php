...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4 display-inline-block">
    <span class="text-muted fw-light">
      <a href="{{url('admin/dashboard')}}">{{__('lang.admin_dashboard')}}</a> / </span>Languages List
  </h4>
  ...
  <button class="btn btn-secondary btn-primary float-right mt-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#add-new-record" aria-controls="add-new-record">
    <span>
      ...
      <span class="d-md-inline-block d-none">Add language</span>
    </span>
  </button>
      ...
      <form method="get">
        <div class="row">
          ...
          <div class="form-group col-sm-3 display-inline-block" >
              <input type="text" class="form-control dt-full-name" placeholder="Name" name="search" value="@if(isset($_GET['search']) && $_GET['search']!=''){{$_GET['search']}}@endif">
          </div>
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="card-title display-inline-block">Languages List</h5>
  ...
  <div class="offcanvas offcanvas-end" id="add-new-record">
    <div class="offcanvas-header border-bottom">
      <h5 class="offcanvas-title" id="exampleModalLabel">Add language</h5>
    ...
    <div class="offcanvas-body flex-grow-1">
      <form class="add-new-record pt-0 row g-2" id="add-record" onsubmit="return  ('add-record');" action="{{url('admin/add-language')}}" method="POST"> @csrf 
        ...
        <div class="col-sm-12">
          <div class="mb-1">
            <label class="form-label" for="code_id">Language Code<span class="required">*</span></label>
              <select id="multicol-country" class="select2 form-control" name="code_id" required>
