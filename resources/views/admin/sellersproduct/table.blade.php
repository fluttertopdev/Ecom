    ...
    $productImage = $firstImage ? url('uploads/' . $firstImage) : url('uploads/product/' . $row->product_image);
                ...
                @endphp
                    <tr>
                        ...
                        <td>{{$row->name}}</td>
                            @php
                    $activeVariant = $row->productVariants->where('isdefault', 'true')->first();
                    $productPrice = $activeVariant ? $activeVariant->price : $row->price;
                ...
                @endphp
                        ...
                        <td>
                            <div class="inline_action_btn">
                                ...
                                <a href="{{ url('admin/edit-product/'.$row->id.'?type=seller') }}" class="edit_icon" title="{{__('lang.admin_edit')}}"><i class="ti ti-pencil me-1"></i></a>
...
<script type="text/javascript">
    document.getElementById('exportBtn').addEventListener('click', function () {
        var url = "{{ route('sellerexportAllproduct') }}";
