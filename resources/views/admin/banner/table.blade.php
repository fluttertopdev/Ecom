        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$row->id}}</td>
                    <td>
                        <img src="{{ url('uploads/banner/website_banner/'.$row->image)}}" class="table_img"
                    ...
                    <td>
                        @if($row->status == 1)
                        <a href="{{ url('admin/update-banner-column/'.$row->id) }}">
                    ...
                    <td>
                        <div class="inline_action_btn">
                                ...
                                onclick="showDeleteConfirmation('banner' , {{ $row->id }})"
                    ...
                    <div class="offcanvas offcanvas-end" id="edit-new-record_{{$row->id}}">
                        <div class="offcanvas-header border-bottom">
                            <h5 class="offcanvas-title"
                                id="exampleModalLabel">Edit Banner</h5>
                            ...
                            <form action="{{url('admin/update-banner')}}" method="POST"
                                ...
                                <div class="col-sm-12">
                                    <label class="form-label"
                                        for="name">Title <span class="required">*</span></label>
                                  ...
                                  <div class="col-sm-12">
                                    <label class="form-label"
                                        for="name">LinK<span class="required">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="basicFullname"
                                ...
                                <div class="col-sm-12 mt-3">
                                        ...
                                        <img src="{{ url('uploads/banner/website_banner/'.$row->image)}}"
