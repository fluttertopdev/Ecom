<div class="offcanvas offcanvas-end" id="add-new-record">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title"
            id="exampleModalLabel">Add New shipping carriers</h5>
        <button type="button" class="btn-close text-reset"
            data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body flex-grow-1">
        <form action="{{url('admin/save-carriers')}}" method="POST"
            ...
            <div class="col-sm-12 mt-3">
                    ...
                    <img src="" class="rounded me-50 hide upload_image_show" id="image-preview-icon"
                        ...
                        onerror="this.onerror=null;this.src=`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWGgKnt4k7cn5fjg0hrhdPqSg8hC_UiWnC1w&s`" />
