...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-6">
                <h4 class="py-3 mb-4">
                  ...
                  {{__('lang.admin_category_list')}}</h4>
            </div>
                ...
                <div class="table-btn-css">
                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="offcanvas"
                        ...
                        <span class="ti-xs ti ti-plus me-1"></span>{{__('lang.admin_category_add')}}
                    </button>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 display-inline-block">
                            ...
                            <a type="reset" class="btn btn-outline-secondary"
                                href="{{url('admin/category')}}">{{__('lang.admin_reset')}}</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        @include('admin/category/add_modal')
        <!--/ Modal to add new record -->
