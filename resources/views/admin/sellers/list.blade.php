        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="table-btn-css">
                    <a href="{{url('admin/add-sellers')}}">
                    <button type="button" class="btn btn-primary waves-effect waves-light">
                        <span class="ti-xs ti ti-plus me-1"></span> Add Sellers
                    </button>
                    </a>
                </div>
            </div>
            ...
            <div class="card-header">
                <form method="get" id="filterForm">
                    <div class="row">
                        ...
                        <div class="col-sm-3 display-inline-block">
                            <button id="submitButton" type="button" class="btn btn-primary data-submit">{{__('lang.admin_search')}}</button>
                            <a type="reset" class="btn btn-outline-secondary" href="{{url('admin/all-sellers')}}">{{__('lang.admin_reset')}}</a>
                        </div>
                    </div>
