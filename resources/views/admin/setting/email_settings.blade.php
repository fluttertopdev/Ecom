...
@endif
@if($row->key == 'from_email_address')
<div class="col-md-3 mb-3 display-inline-block width-32-percent mr-10">
    <label class="form-label" for="from_email_address">{{__('lang.admin_from_email_address')}}</label>
    <input type="text" class="form-control" name="from_email_address" placeholder="{{__('lang.admin_from_email_address_placeholder')}}" value="{{$row->value}}">
</div>
@endif