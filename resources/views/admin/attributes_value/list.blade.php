...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-md-6">
                <div class="table-btn-css">
                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="offcanvas"
                        ...
                        <span class="ti-xs ti ti-plus me-1"></span>Attribute Add
                    </button>
                </div>
            </div>
                      ...
                      <!--   <div class="col-sm-3 display-inline-block">
                        ...
                        <div class="col-sm-3 display-inline-block">
                            ...
                            <a type="reset" class="btn btn-outline-secondary"
                                href="{{url('admin/attributes')}}">{{__('lang.admin_reset')}}</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <!-- Bordered Table -->
        @include('admin/attributes_value/table')
        <!--/ Bordered Table -->

        <!-- Modal to add new record -->
        @include('admin/attributes_value/add_modal')
        <!--/ Modal to add new record -->
