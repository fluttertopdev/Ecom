<div class="offcanvas offcanvas-end" id="add-new-record">
  ...
  <form action="{{url('admin/store-shipping')}}" method="POST" enctype="multipart/form-data" id="shippingForm">
    @csrf
    ...
    <div class="col-sm-12 mt-3" id="existingCategoryField">
        ...
        <select id="category-select" class="form-control select2 form-select validate-field" name="country_id">
    ...
    <div class="col-sm-12 mt-3 d-none" id="newCategoryField">
        <div class="input-group input-group-merge">
            <input type="text" id="basicFullname" class="form-control dt-full-name validate-field" name="newcountryname" placeholder="Country Name" aria-label="John Doe" aria-describedby="basicFullname2">
        </div>
    </div>
    ...
    <div class="col-sm-12 mt-3" id="existingStateField">
        ...
        <select id="State-select" name="state_id" class="select2 form-select form-select validate-field" data-placeholder="">
    ...
    <div class="col-sm-12 mt-3 d-none" id="newStateField">
        ...
        <div class="input-group input-group-merge">
            <input type="text" id="basicStateName" class="form-control dt-full-name validate-field" name="new_state_name" placeholder="State Name" aria-label="State Name" aria-describedby="basicStateName">
        </div>
    </div>
    ...
    <div class="col-sm-12 mt-3" id="existingCityField">
        ...
        <select class="form-control select2 form-select validate-field" id="city-select" name="city_id">
    ...
    <div class="col-sm-12 mt-3 d-none" id="newCityField">
        ...
        <div class="input-group input-group-merge">
            <input type="text" id="basicCityName" class="form-control dt-full-name validate-field" name="new_city_name" placeholder="City Name" aria-label="City Name" aria-describedby="basicCityName">
        </div>
    </div>
    ...
    <div class="col-sm-12 mt-3">
        ...
        <div class="input-group input-group-merge">
            <input type="text" id="basicCityName" maxlength="6" class="form-control dt-full-name validate-field" name="postcode" placeholder="Post Code" aria-label="Post code" aria-describedby="basicCityName">
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        // Validate only the visible fields with the class 'validate-field'
        const fields = document.querySelectorAll('.validate-field');
        fields.forEach(function (field) {
            if (field.closest('.d-none') === null && field.value.trim() === "") {
