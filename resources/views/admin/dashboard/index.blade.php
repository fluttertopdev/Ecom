                        ...
                        <div class="row gy-3">
                          ...
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0">{{ number_format($todaySale, 2) }}</h5>
                          ...
                          <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="card-info">
                                <h5 class="mb-0">{{ number_format($totalSale, 2) }}</h5>
...
<div class="col-xxl-12 mt-4">
    <div class="card h-100">
        <div class="card-body p-0 text-center">
            <!-- Title: Revenue Chart -->
            <h3 id="" class="mt-2 mb-0">Inhouse/Sellers Orders</h3>
...
<script type="text/javascript">
                ...
                tooltip: {
                    ...
                    callbacks: {
                        ...
                        label: (tooltipItem) => {
                            ...
                            return `${tooltipItem.dataset.label}: Order Amount: ${orderTotal} | Orders: ${orderQuantity}`;
                        },
                    },
                },
            },
    ...
    function updateChartData(timeRange) {
        fetch('/admin/orders-data?time_range=' + timeRange)  // Update with your web route
            .then(response => response.json())
            .then(data => {
                // Update chart with the fetched data
                mountainChart.data.labels = data.labels;
                mountainChart.data.datasets[0].data = data.inHouseTotal; // Use order_total for the data
                mountainChart.data.datasets[1].data = data.sellerTotal; // Use order_total for the data
                mountainChart.data.datasets[0].orderQuantity = data.inHouseOrders; // Store order_quantity for tooltip
                mountainChart.data.datasets[1].orderQuantity = data.sellerOrders; // Store order_quantity for tooltip
                mountainChart.data.datasets[0].orderTotal = data.inHouseTotal; // order_total for In-House orders
                mountainChart.data.datasets[1].orderTotal = data.sellerTotal; // order_total for Seller orders
...
function fetchRevenueData(period) {
    fetch(`/admin/get-revenue-data?period=${period}`)
        .then((response) => response.json())
        .then((data) => {
