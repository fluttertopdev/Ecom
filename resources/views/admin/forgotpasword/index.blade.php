            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-4 mt-2">
                <a href="" class="app-brand-link gap-2">
                  <span class="app-brand-text demo text-body fw-bold ms-1">Forget Password</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="{{ url('/do-forget-password') }}" method="POST">
              @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit">Forget</button>
                </div>
              </form>
