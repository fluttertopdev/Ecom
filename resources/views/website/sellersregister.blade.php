...
<div class="form-group">
    ...
    <div class="form-group">
      <label>
        <input style="margin-right: 2px;" class="terms_and_policy" name="terms_and_policy" type="checkbox" >{{__('lang.By_clicking')}}  <a href="{{url('page/seller-term-and-condition')}}">{{__('lang.terms_and_policy')}}</a>
        <div class="text-danger"></div>
      </label>
