...
<script>
    ...
    return;
            ...
            var data = {
                product_ids: $('.product_id').map(function () { return $(this).val(); }).get(),
                shippingamount: $('input[name="shippingtotal"]').val(),
                product_price: $('.product_price').map(function () { return $(this).val(); }).get(),
                product_tax: $('.product_tax').map(function () { return $(this).val(); }).get(),
                grandTotalamount: $('input[name="grandtotal"]').val(),
                shippingAddressId: $('input[name="address"]:checked').data('shippingaddressid'),
                payment_method: paymentMethod,
                productshipping: $('.shippingofproduct').map(function () { return $(this).val(); }).get(),
                productcoupndiscount: $('.discountofproduct').map(function () { return $(this).val(); }).get(),
                _token: '{{ csrf_token() }}'
            };
