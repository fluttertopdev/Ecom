...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet">
  ...
  <div class="row">
    ...
    <form id="" method="GET" action="{{ url('productlist/'.$segment1) }}"> 
...
<div class="d-inline-block ms-2">
          ...
          <a href="{{ url('productlist/'.$segment1.'/'.$segment2) }}"> <button class="btn btn-outline-secondary btn-sm font-sm color-gray-900 font-medium" id="resetFilter" type="submit">Reset</button> </a>
        </div>
                     ...
                     $productImage = $firstImage ? url('uploads/' . $firstImage) : url('uploads/product/' . $each->product_image);
                            $productPrice = $activeVariant ? $activeVariant->price : $each->price;
                             $discontPrice = $activeVariant ? $activeVariant->price :  $each->discount;
                              $discontcount = $activeVariant ? $activeVariant->price  : $each->discount;
    ...
    <a class="btn btn-wishlist mb-10 addwishlist {{ $isInWishlist ? 'activeheart' : '' }}"  
       ...
       href="#">
                        ...
                        <div class="info-right">
                            <a class="font-xs color-gray-500" href="{{ url('product-details/'.$each->slug) }}">{{$each->brand->name}}</a><br>
...
@endif            
              ...
              <div class="sidebar-border mb-0">
                ...
                <div class="sidebar-content">
                  <ul class="list-nav-arrow">
                    ...
                    <li><a href="{{ url('product-list/'.$each->slug) }}">{{$each->name}}</a></li>
    ...
    <div class="sidebar-content">
        ...
        <form action="{{ url('productlist/'.$segment1.'/'.$segment2) }}" method="get" id="filter-form">
            <!-- Brand dropdown -->
...
<!-- Reset Button -->
<a href="{{ url('productlist/'.$segment1) }}">
